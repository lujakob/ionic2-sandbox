...
import { BmgInfiniteScroll } from './bmg-infinite-scroll';

/**
 * @private
 */
@Component({
    selector: 'bmg-infinite-scroll-content',
    template:
...
export class BmgInfiniteScrollContent {
    ...
    constructor(public inf: BmgInfiniteScroll, private _config: Config) {
    }
